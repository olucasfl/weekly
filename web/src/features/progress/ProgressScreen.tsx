  ...
  return (
    <>
      ...
      <div className="screen-body">
        ...
        {/* Metas — mesmo card interativo da Semana: dá pra marcar progresso e
            criar/editar direto aqui, sem redirecionar pra outra tela. */}
        <WeekGoalsCard weekStartISO={weekStart} />
